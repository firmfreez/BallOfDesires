...
@FeatureScope
class BallPresenter @Inject constructor(router: Router): BasePresenter<BallFragment>() {
    @Inject
    lateinit var yesNoService: YesNoService
    ...
    private fun showErrorDialog() {
        router.setResultListener(TextDialogFragment.TEXT_DIALOG_RESULT) {
            when (it as String) {
